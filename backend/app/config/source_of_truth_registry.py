...
SOURCE_OF_TRUTH: Dict[str, DomainEntry] = {
    ...
    "business_slice": {
        ...
        "secondary": [
            ...
            "ops.v_real_business_slice_month_from_hour",
            "ops.real_business_slice_hour_fact",
            "ops.v_real_trips_enriched_base",
            "ops.v_real_trips_business_slice_resolved",
            "ops.v_real_trips_business_slice_resolved_mv12",
            "ops.v_real_trips_business_slice_base",
        ],
        "legacy": [],
        "grain": "hourly_first",
        "canonical_chain": True,
        ...
        "freshness_dataset": None,
        "parity_audit_applies": False,
        "notes": "Hourly-first: trip_hour_start en enriched → hour_fact por bloques; month_fact incremental por mes (API). Vista mv_real_business_slice_monthly = compat. commission_pct = SUM(revenue)/SUM(total_fare). connected_only_drivers_status NOT_IMPLEMENTED.",
    },
    "behavioral_alerts": {
