...
# ── Legacy stubs (migrated to /drivers/* fact endpoints; kept for ops.py import compatibility) ──

def get_supply_parks(**_kwargs):
    return []

def get_supply_series(**_kwargs):
    return []

def get_supply_summary(**_kwargs):
    return {}

def get_supply_global_series(**_kwargs):
    return []

def get_supply_segments_series(**_kwargs):
    return []

def get_supply_alerts(**_kwargs):
    return []
