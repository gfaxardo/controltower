"""Backfill FACT_WEEKLY from FACT_DAILY (600 rows per month vs 2.7M in raw).
Much faster: already aggregated by day, just need to roll-up by week with COUNT DISTINCT for active_drivers."""
