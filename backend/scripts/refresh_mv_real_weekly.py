...
def refresh_mv_weekly(conn, timeout_seconds=7200):
    """
...
def check_mv_weekly_status(conn):
...
def main():
    ...
    try:
        with get_db() as conn:
            ...
            success, elapsed = refresh_mv_weekly(conn, args.timeout)
