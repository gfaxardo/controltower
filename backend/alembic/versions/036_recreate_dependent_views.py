"""
Recrear vistas que dependen de v_real_universe_by_park_for_hunt
(quedaron borradas por CASCADE al ejecutar 035).
"""
from alembic import op

revision = "036_recreate_dep_views"
down_revision = "035_real_city_country_keys"
branch_labels = None
depends_on = None
