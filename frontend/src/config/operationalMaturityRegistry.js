...
export const OPERATIONAL_MATURITY_REGISTRY = {
  ...
  drivers_pilot: {
    ...
    legacy: false,
    experimental: false,
    description: 'Operational Pilot — validación con operadores reales de las colas accionables.',
    ...
    statusLabel: 'Hardening',
    statusTone: 'amber',
    governanceReason: 'Control Foundation (H2). Piloto operativo para validar si las colas accionables mejoran supply con operadores humanos. 5 personas, varios días, registro de acciones y outcomes.',
    dependencies: ['driver_identity_service', 'driver_actionable_supply_service', 'driver_workflow_service'],
    allowedInCurrentPhase: true,
  },
  drivers_lifecycle: {
    layer: 'Intelligence',
  ...
  drivers_operational_workflows: {
    ...
    legacy: false,
    experimental: true,
    description: 'Operational Workflows — gestión multi-step de casos y campañas.',
    endpoints: ['/drivers/workflow', '/drivers/workflow-metrics'],
    statusLabel: 'Under Construction',
    statusTone: 'purple',
    governanceReason: 'Execution Layer. Placeholder — ya existe D5 Workflow. Se integrará con campañas en H3.2.',
    dependencies: ['D5 Workflow Execution', 'CRM Bridge'],
    allowedInCurrentPhase: false,
  },
  drivers_campaign_intelligence: {
    ...
    legacy: false,
    experimental: false,
    description: 'Campaign Intelligence — Campaign Builder + universos accionables desde queues. Define el universo; CRM ejecuta comunicación.',
    ...
    statusLabel: 'Hardening',
    statusTone: 'amber',
    governanceReason: 'Execution Layer (H3.2). Campaign foundation construida. Pendiente: CRM Bridge (H3.3) para sincronización bidireccional.',
    dependencies: ['Action Queues', 'CRM Bridge (H3.3)', 'Campaign Effectiveness (H3.4)'],
    allowedInCurrentPhase: true,
  },
  drivers_crm_bridge: {
    layer: 'Execution',
    ...
    legacy: false,
    experimental: false,
    description: 'CRM Bridge — puente bidireccional con CRM. Export payload, import outcomes, sync tracking, graceful degradation.',
    ...
    statusLabel: 'Hardening',
    statusTone: 'amber',
    governanceReason: 'Execution Layer (H3.3). CRM bridge operativo. Pendiente: Campaign Effectiveness (H3.4) para medir lift/ROI.',
    dependencies: ['Campaign Intelligence (H3.2)', 'Campaign Effectiveness (H3.4)'],
    allowedInCurrentPhase: true,
  },
  drivers_campaign_effectiveness: {
    ...
    legacy: false,
    experimental: false,
    description: 'Campaign Effectiveness — medición de efectividad real post-campaña. Pre/post trip activity, reactivation rate, observed lift.',
    endpoints: ['/drivers/campaigns/{id}/effectiveness', '/drivers/campaigns/effectiveness-summary'],
    statusLabel: 'Hardening',
    statusTone: 'amber',
    governanceReason: 'Execution Layer (H3.4). Effectiveness analytics operativos. "Observed lift", no causalidad. Pendiente: Learning Engine para patrones cross-campaign.',
    dependencies: ['Campaign Intelligence', 'CRM Bridge', 'driver_daily_activity_fact'],
    allowedInCurrentPhase: true,
  },
  drivers_data_foundation: {
    ...
    legacy: false,
    experimental: true,
    description: 'Data Foundation — inspección de fuentes, freshness map, identity y phone coverage.',
    endpoints: ['/drivers/raw-freshness', '/drivers/identity'],
    statusLabel: 'Hardening',
    statusTone: 'amber',
    governanceReason: 'Foundation Layer. Placeholder — ya existe DriverDataFoundation card. Se expandirá con más métricas.',
    dependencies: ['driver_raw_freshness_service', 'driver_identity_service'],
    allowedInCurrentPhase: false,
  },
  drivers_operational_health: {
    ...
    legacy: false,
    experimental: true,
    description: 'Operational Health — monitoreo de servicios Drivers, health checks y alertas.',
    endpoints: ['/drivers/health'],
    statusLabel: 'Hardening',
    statusTone: 'amber',
    governanceReason: 'Foundation Layer. Placeholder — ya existe /drivers/health. Se expandirá con dashboard.',
    dependencies: ['driver_health_endpoint'],
    allowedInCurrentPhase: false,
  },
  drivers_capability_governance: {
    ...
    legacy: false,
    experimental: true,
    description: 'Capability Governance — mapa de madurez, roadmap y dependencias de Drivers OS.',
    endpoints: [],
    statusLabel: 'Hardening',
    statusTone: 'amber',
    governanceReason: 'Foundation Layer. Placeholder — la gobernanza ya existe en los registries. Se creará vista dedicada.',
    dependencies: ['operationalMaturityRegistry', 'controlTowerNavigationRegistry'],
    allowedInCurrentPhase: false,
  },
