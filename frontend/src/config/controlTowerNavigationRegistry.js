...
export const CONTROL_TOWER_NAVIGATION_REGISTRY = [
  ...
  {
    key: 'operacion_omniview_v2_professional',
    label: 'Omniview V2',
    tab: 'Operación',
    component: 'OmniviewV2ProfessionalPage',
    route: '/operacion/omniview-v2-professional',
    engine: ENGINE.CONTROL_FOUNDATION,
    phaseStatus: PHASE_STATUS.ACTIVE,
    visibility: VISIBILITY.KEEP_VISIBLE,
    productionReady: true,
    requiresValidation: false,
    reason: 'OV2 — Professional operational UI. Default Omniview experience. Ownership/freshness/traceability certified.',
    endpoints: ['/ops/omniview-v2/matrix', '/ops/omniview-v2/shell', '/ops/omniview-v2/health', '/ops/omniview-v2/plan-real/monthly'],
  },
  {
    ...
    productionReady: false,
    requiresValidation: false,
    reason: 'OV2 shadow fallback. Professional UI is default. This route preserved for internal debugging.',
    endpoints: ['/ops/omniview-v2/shell', '/ops/omniview-v2/matrix', '/ops/omniview-v2/health', '/ops/omniview-v2/plan-real/monthly'],
  },
  {
  ...
  {
    key: 'lima_growth_intelligence',
    label: 'Intelligence',
    tab: 'Lima Growth',
    component: 'LimaGrowthIntelligenceDashboard',
    route: '/lima-growth/intelligence',
    engine: ENGINE.CONTROL_FOUNDATION,
    phaseStatus: PHASE_STATUS.ACTIVE,
    visibility: VISIBILITY.KEEP_VISIBLE,
    productionReady: true,
    requiresValidation: false,
    reason: 'LG-UI-1A: Growth Intelligence Dashboard MVP — Overview, Programs, Segments, Movement, RNA, Driver Explorer.',
    endpoints: ['/growth/health', '/growth/freshness', '/growth/operability', '/yego-lima-growth/operational-summary', '/yego-lima-growth/taxonomy/summary', '/yego-lima-growth/movement/summary', '/yango-loyalty/summary'],
  },
]
