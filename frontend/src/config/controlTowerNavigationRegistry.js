...
export const CONTROL_TOWER_NAVIGATION_REGISTRY = [
  ...
  },
  {
    ...
    productionReady: true,
    requiresValidation: false,
    reason: 'Diagnostic Engine (Fase 2A.2): benchmarking comparativo de patrones operativos. No genera recomendaciones automáticas.',
    endpoints: ['/driver-behavior/summary', '/driver-behavior/group-benchmarks', '/driver-behavior/top-vs-risk', '/driver-behavior/distributions'],
  },
  {
  ...
  },
  {
    ...
    productionReady: true,
    requiresValidation: false,
    reason: 'Control Foundation: vista de Business Slice ejecutiva.',
  ...
  },
  {
    ...
    productionReady: true,
    requiresValidation: false,
    reason: 'Control Foundation: vista Omniview unificada.',
    endpoints: ['/ops/business-slice/monthly', '/ops/business-slice/weekly', '/ops/business-slice/daily'],
  },
